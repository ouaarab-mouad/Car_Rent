    ...
    <footer>
      <div className="firstSectionFooter" >
        <div className="footerCard" >
          <div>
            <img src="/images/footerIcons/car.png" alt="" />
          </div>
          <div>
            <h3>Location</h3>
          </div>
        ...
        <div className="footerCard" >
          <div>
            <img src="/images/footerIcons/localisation.png" alt="" />
          </div>
          <div>
            <div>
              <p>Address</p>
        ...
        <div className="footerCard">
          <div>
            <img src="/images/footerIcons/email.png" alt="" />
          </div>
          <div>
            <p>Email</p>
        ...
        <div className="footerCard">
          <div>
            <img src="/images/footerIcons/tel.png" alt="" />
          </div>
          <div>
            <p>Phone</p>
      ...
      <div className="secondSectionFooter">
        <div className="socialMedia">
          ...
          <div className="socialMediaIcons" >
            ...
            <img src="/images/SocialMedia/x.png" alt="" />
            </a>
            <a
